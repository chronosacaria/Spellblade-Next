...
public class AmethystEntityModel<T extends Entity & FlyingItemEntity> extends EntityModel<T> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(new Identifier("spellbladenext", "amethyst_shard"), "main");
    private final ModelPart bone;
    private final ModelPart root;

    public AmethystEntityModel(ModelPart root) {
    ...
    public static TexturedModelData createBodyLayer() {
        ...
        ModelPartData bone = partData.addChild("bone", ModelPartBuilder.create().uv(0, 3).cuboid(-1.0F, -1.0F, 0.0F, 1.0F, 1.0F, 4.0F, new Dilation(0.0F))
                ...
                ModelTransform.of(0.0F, 0, 0.0F, -0, 0.0F, 0));
