package net.spellbladenext.entities.renderers;
    ...
    public void render(T p_116111_, float p_116112_, float p_116113_, PoseStack p_116114_, MultiBufferSource p_116115_, int p_116116_) {
        ...
        if (!p_116111_.isInvisible()) {
            if (p_116111_.tickCount >= 2) {
                ...
                this.itemRenderer.renderStatic(new ItemStack(SpellbladeNext.ICICLE_2.get()), ItemTransforms.TransformType.NONE, p_116116_, OverlayTexture.NO_OVERLAY, p_116114_, p_116115_, p_116111_.getId());
