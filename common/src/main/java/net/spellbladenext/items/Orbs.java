...
*/
    ...
    public static final Entry fireOrb = orb("orb_fire",
            Material.matching(Tiers.GOLD, SpellbladeNext.RUNEBLAZE_PLATING.get()),MagicSchool.FIRE)
    ...
    public static final Entry frostOrb = orb("orb_frost",
            Material.matching(Tiers.IRON, SpellbladeNext.RUNEFROSTED_INGOT.get()),MagicSchool.FROST)
